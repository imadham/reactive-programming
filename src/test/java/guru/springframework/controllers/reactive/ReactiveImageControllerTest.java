...
public class ReactiveImageControllerTest {
    ...
    ReactiveImageController controller;
    ...
    public void setUp() throws Exception {
        ...
        controller = new ReactiveImageController(reactiveImageService, reactiveRecipeService);
    ...
    public void getImageForm() throws Exception {
        ...
        when(reactiveRecipeService.findCommandById(anyString())).thenReturn(Mono.just(command));
    ...
    public void handleImagePost() throws Exception {
        ...
        when(reactiveImageService.saveImageFile(anyString(),any())).thenReturn(Mono.empty());

        mockMvc.perform(multipart("/recipe/1/image").file(multipartFile))
                .andExpect(status().is3xxRedirection())
                .andExpect(header().string("Location", "/recipe/1/show"));

        verify(reactiveImageService, times(1)).saveImageFile(anyString(), any());
    }
